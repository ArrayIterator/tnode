...
pub struct Settings {
    ...
    pub(crate) default_dns: Option<Arc<DnsChoice>>,
}
...
impl Settings {
    ...
    pub(crate) fn set_default_dns<D: Into<Arc<DnsChoice>>>(&mut self, dns: Option<D>) {
        self.default_dns = dns.map(|e|e.into())
    }
}
...
impl Default for Settings {
    fn default() -> Self {
        Self {
            ...
            default_max_redirects: MAX_REDIRECTS,
            default_follow_redirect: DEFAULT_FOLLOW_REDIRECT,
